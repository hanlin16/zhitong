...
window.lArea = function() {
    ...
    return a.prototype = {init: function(a) {
            ...
            var b = this;
            if ("object" == typeof b.params.data)
                b.data = b.params.data, a();
            else {
            ...
            function b(a) {
                ...
                var h = i.gearArea.querySelector(".area_province"), j = i.gearArea.querySelector(".area_city"), k = i.gearArea.querySelector(".area_county");
            ...
            function e(a) {
                ...
                b["pos_" + b.id] = b["o_d_" + b.id] + c, b.style["-webkit-transform"] = "translate3d(0," + b["pos_" + b.id] + "rem,0)", b.setAttribute("top", b["pos_" + b.id] + "rem")
            }
            function f(a) {
                a.preventDefault();
                for (var b = a.target; ; ) {
            ...
            function g(a) {
                ...
                clearInterval(a["int_" + a.id]), a["int_" + a.id] = setInterval(function() {
                    var d = a["pos_" + a.id], e = a["spd_" + a.id] * Math.exp(-.03 * b);
                    if (d += e, Math.abs(e) > .1)
                        ;
                    else {
                        e = .1;
                    ...
                    a["pos_" + a.id] = d, a.style["-webkit-transform"] = "translate3d(0," + d + "rem,0)", a.setAttribute("top", d + "rem"), b++
                }, 30)
            }
            function h(a, b) {
            ...
            var b = this, c = a || [], d = c.length, e = b.gearArea.querySelectorAll(".gear"), f = e[b.index].getAttribute("val");
            if (e[b.index].setAttribute("data-len", d), d > 0) {
                for (var g = (c[f].id, c[f].child), h = "", i = 0; d > i; i++)
                    h += "<div class='tooth'  ref='" + c[i].id + "'>" + c[i].name + "</div>";
                if (e[b.index].innerHTML = h, e[b.index].style["-webkit-transform"] = "translate3d(0," + 3 * -f + "rem,0)", e[b.index].setAttribute("top", 2 * -f + "em"), b.index++, b.index > 2)
                    return void (b.index = 0);
                b.setGearTooth(g)
            } else
                e[b.index].innerHTML = "<div class='tooth'></div>", b.index = 0
        },finish: function(a) {
            ...
            a.preventDefault();
            var b = this, c = new CustomEvent("input");
