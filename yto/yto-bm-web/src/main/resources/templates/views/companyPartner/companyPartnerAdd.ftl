...
<form id="companyPartnerDataForm" method="post" class="form-horizontal" action="">
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="text" class="form-control" id="inputFullName" name="fullName" placeholder="请输入全称" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label" for="inputShortName">简称：</label>
		<div class="col-sm-5">
			<input type="text" class="form-control" id="inputShortName" name="shortName" placeholder="请输入简称" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="text" class="form-control" id="inputLinkman" name="linkman" placeholder="请输入联系人" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label" for="inputLinkmanPhoneNo">联系电话：</label>
		<div class="col-sm-5">
			<input type="text" class="form-control" id="inputLinkmanPhoneNo" maxlength="11" name="linkmanPhoneNo" placeholder="请输入联系电话" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label" for="inputLinkmanEmail">联系人邮箱：</label>
		<div class="col-sm-5">
			<input type="text" class="form-control" id="inputLinkmanEmail" name="linkmanEmail" placeholder="请输入邮箱" />
		</div>
	</div>
</form>
