      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header" style="text-align: center">
            	 易通出单详情
            <small class="pull-right">出单日期: ${proposalDetail.payTime?string('yyyy-MM-dd') !}</small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
          	...
          	<div class="col-sm-12 table-responsive" >
		       <table class="table" >
		       	...
		       	<tr>
		       		...
		       		<td style="border: none; border-right-style: solid"></td>
          	...
          	<div class="col-sm-12 table-responsive" >
		       <table class="table" style="margin-bottom: 0px;">
		       	...
		       	<tr>
		       		...
		       		<td style="border: none;">交强险起保日期：${proposalDetail.ciStartDate?string('yyyy-MM-dd') !}</td>
		       		<td style="border: none;">交强险终保日期：${proposalDetail.ciEndDate?string('yyyy-MM-dd') !}</td>
		       	</tr>
		       	<tr>
		       	...
		       	<tr>
		       		...
		       		<td style="border: none;">商业险起保日期：${proposalDetail.biStartDate?string('yyyy-MM-dd') !}</td>
		       		<td style="border: none;">商业险终保日期：${proposalDetail.biEndDate?string('yyyy-MM-dd') !}</td>
		       	</tr>
		       </table>
		   </div>
